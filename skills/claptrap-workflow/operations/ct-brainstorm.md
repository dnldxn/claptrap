...
- After the design is approved, create `.planning/milestones/M##-slug/MILESTONE_SUMMARY.md` from the [MILESTONE-SUMMARY template](../templates/MILESTONE-SUMMARY.md).
- Create phase summary files at `.planning/milestones/M##-slug/phases/P##-slug/PHASE_SUMMARY.md` from the [PHASE-SUMMARY template](../templates/PHASE-SUMMARY.md).
