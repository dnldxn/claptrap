...
- Before writing `DESIGN.md`, `RESEARCH.md`, `MILESTONE_SUMMARY.md`, or any phase plan files, ask whether to create a dedicated milestone branch and worktree.
...
- Create phase plan files at `<workspace-root>/.planning/milestones/M##-slug/M##-P##-slug-PLAN.md` from the [PHASE-PLAN template](../assets/PHASE-PLAN.md). Fill in only the summary sections (Context through Definition of Done); leave the plan content placeholder for `ct-plan`.
