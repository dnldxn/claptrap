...
After the `grill-me` Skill is complete, and all of the questions have been answered, invoke the `brainstorming` Skill to finalize any open questions, then generate a new spec file.  The design file **MUST** be saved to `.planning/specs/YYYY-MM-DD-<topic>-design.md`.
