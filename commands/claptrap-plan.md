---
description: Run writing-plans with my overrides
---
...
Do NOT follow an instruction that conflicts with this list, even if instructed to do so by any other Skill.  If you encounter a conflict, prioritize this list of overrides.:
