...
1. Ask clarifying questions one at a time; spawn `research` subagent if external docs could help.
2. Explore approaches; spawn `explore` subagent if codebase context is needed.
3. Draft and validate the design in sections with user feedback.
4. Output the final design using the [design template](templates/design.md).
