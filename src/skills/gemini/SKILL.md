---
name: gemini
description: Use the Google Gemini CLI to analyze code, plan, and perform other tasks.
metadata:
   source: https://skills.sh/softaworks/agent-toolkit/gemini
---
...
| Code review with auto-edits | auto\_edit            | -m gemini-3-pro-preview --approval-mode auto\_edit                          |
...
| Interactive with prompt     | auto\_edit or default | -i "prompt" --approval-mode <mode>                                          |
